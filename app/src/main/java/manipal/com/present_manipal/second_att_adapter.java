...
public class second_att_adapter extends RecyclerView.Adapter<second_att_adapter.ViewHolder> {

    public Context mContext;
    ArrayList<attendance_array> list;

    public second_att_adapter(Context mContext, ArrayList<attendance_array> list) {
