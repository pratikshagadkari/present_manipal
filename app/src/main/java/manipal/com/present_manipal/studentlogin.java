...
public class studentlogin extends AppCompatActivity {
        ...
        if(TextUtils.isEmpty(pass)){
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    database.getReference().child("Students").child(auth.getUid()).addValueEventListener(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            if(dataSnapshot.exists()){
                                ...
                                Toast.makeText(studentlogin.this,"Wrong User Type",Toast.LENGTH_SHORT).show();
                                Intent i=new Intent(studentlogin.this,choice_page.class);
                                startActivity(i);
                                auth.signOut();
                            }
                        }
    ...
    public void change(View view) {
        Intent i=new Intent(studentlogin.this,forgot_password_student.class);
        startActivity(i);
    }
}
